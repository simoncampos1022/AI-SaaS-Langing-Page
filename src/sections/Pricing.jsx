      ...
      <Element name="pricing">
        <div className='container'>
          <div className='max-w-960 pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16'>
            ...
            <div className='relative z-4 mx-auto flex w-[375px] justify-between rounded-3xl border-[3px] border-s4 border-s4/25 bg-s1/50 p-2 backdrop-blur-[6px] max-md:w-[310px]'>
          ...
          {/* pricing */}
          <div className='scroll-hide relative z-2 -mt-12 flex items-start max-xl:gap-5 max-xl:overflow-x-auto max-xl:pt-6'>
