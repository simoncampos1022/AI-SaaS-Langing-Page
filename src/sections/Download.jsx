        ...
        <div className='container'>
          <div className='flex items-center'>
            <div className='relative mr-6 flex-540 max-xl:flex-280 max-lg:flex-256 max-md:flex-100'>
              ...
              <p className='body-1 mb-10 max-w-md uppercase text-p4'>Try it now for free on iOS, Android, PC, Web - Whatever your flavor, we've got you covered</p>
            ...
            <div className='mb-10 max-md:hidden'>
              <div className='download_preview-before download_preview-after rounded-40 relative w-[956px] border-2 border-s5 p-6'>
